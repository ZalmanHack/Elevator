...
from PyQt5.Qt import QMainWindow, QHBoxLayout, QVBoxLayout, QSpacerItem, QSizePolicy, QGridLayout, QPushButton, QSlider, \
    Qt
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def setupUi(self, window):
        ...
        self.gLayout.addWidget(self.liftShaft, 0, 0, 3, 1)
        self.gLayout.addWidget(self.digitTable, 0, 1, 1, 1)
        self.gLayout.addWidget(self.sensors, 1, 1, 1, 1)
        self.gLayout.addWidget(self.engine, 2, 1, 1, 1)
    ...
    def _init_connects_sensors(self):
        ...
        self.sensors.checked_weight.connect(self.computer.set_weight)
        ...
        self.sensors.set_table_info.connect(self.digitTable.set_table_info)
        pass
