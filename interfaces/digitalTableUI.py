...
class Ui_digital_table(object):
    def setupUi(self, digital_table):
        ...
        digital_table.setMaximumSize(QtCore.QSize(360, 124))
...
"}")
        ...
        self.down_lb = QtWidgets.QLabel(self.central)
...
"}")
        ...
        self.floor_lb_1 = QtWidgets.QLabel(self.central)
...
"}")
        ...
        self.floor_lb_2 = QtWidgets.QLabel(self.central)
...
"}")
        ...
        self.floor_lb_3 = QtWidgets.QLabel(self.central)
...
"}")
        ...
        self.floor_lb_4 = QtWidgets.QLabel(self.central)
...
"}")
        ...
        self.floor_lb_5 = QtWidgets.QLabel(self.central)
...
"}")
        ...
        self.up_lb = QtWidgets.QLabel(self.central)
